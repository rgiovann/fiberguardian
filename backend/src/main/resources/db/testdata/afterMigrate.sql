...
('CopperFibra', '12345678000190', utc_timestamp),
('Cocari', '23456789000101', utc_timestamp),
('Fiação São Bento', '34567890000112', utc_timestamp),
('Tecelagem Aurora', '45678901000123', utc_timestamp),
('Tinturaria Brasil', '56789012000134', utc_timestamp),
('Fibras Unidas', '67890123000145', utc_timestamp),
('Algodoeira Nacional', '78901234000156', utc_timestamp),
('Malharia Tropical', '89012345000167', utc_timestamp),
('CooperFibra Paraná', '90123456000178', utc_timestamp),
('Fios Catarinenses', '11223344000189', utc_timestamp),
('Textil Horizonte', '22334455000190', utc_timestamp),
('Linhas Sul América', '33445566000101', utc_timestamp),
('PoliFios Brasil', '44556677000112', utc_timestamp),
('Tintas e Corantes Alfa', '55667788000123', utc_timestamp),
('Tecidos Planalto', '66778899000134', utc_timestamp),
('Cooperativa Algodoeira Paulista', '77889900000145', utc_timestamp),
('Fibras do Vale', '88990011000156', utc_timestamp),
('TexFibra Group', '99100200000167', utc_timestamp),
('Malhas Premium', '12210310000178', utc_timestamp),
('Fiação Imperial', '23320430000189', utc_timestamp),
('Corantes Delta', '34430540000190', utc_timestamp),
('Têxtil Santa Luzia', '45540650000101', utc_timestamp),
('Fios & Tramas', '56650760000112', utc_timestamp),
('Algodoeira do Cerrado', '67760870000123', utc_timestamp),
('FibraTech Solutions', '78870980000134', utc_timestamp),
('Indústria de Fios Paulista', '89980090000145', utc_timestamp),
('Trama Forte Ltda', '90090100000156', utc_timestamp),
('ColorFibra', '11101210000167', utc_timestamp),
('TexBrasil Insumos', '22212320000178', utc_timestamp),
('Fiação Modelo', '33323430000189', utc_timestamp);
